...
**Last updated:** 2026-07-29 (Today Tasks & Reminders split into Active/Completed-today cards, custom empty-state illustration) -- **Live at:** [atlas.abhisheksikka.com](https://atlas.abhisheksikka.com) -- **Current cache version:** `atlas-offline-shell-v41` -- **Latest migration:** `015_sleep_morning_note.sql`
