...
**Last updated:** 2026-07-27 (Final polish pass: Insight Pill contrast fixed, Tasks & Reminders rows now show date+time, Workout tint softened to amber) · **Live at:** [atlas.abhisheksikka.com](https://atlas.abhisheksikka.com) · **Current cache version:** `atlas-offline-shell-v38` · **Latest migration:** `015_sleep_morning_note.sql`
