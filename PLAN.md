...
**Last updated:** 2026-07-28 (**AI action-layer rebuild shipped** — two-call extraction architecture: write-intent messages now fire extraction call + prose call in parallel; root cause of all 6 write-flow failures resolved in code; live testing still needed — see SESSION_LOG.md 2026-07-28 Sonnet entry) -- **Live at:** [atlas.abhisheksikka.com](https://atlas.abhisheksikka.com) -- **Current cache version:** `atlas-offline-shell-v55` -- **Latest migration:** `016_ai_notebook.sql`
